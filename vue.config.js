...
const output =
  NodeRun !== "local"
    ? {
        ...
        filename: `js/[name].[chunkhash:6]`+ new Date().getTime()+`.js`,
        chunkFilename: `js/[name].[chunkhash:6]`+ new Date().getTime()+`.js`,
      }
    : {};
...
module.exports = {
  // 基本路径
  publicPath: './',
  // publicPath: NodeRun === 'local' ? './' : `https://cn-resourses.oss-cn-shanghai.aliyuncs.com/publish-resources/${Env == 'preview' ? 'preview' : 'production'}/light-weight-web/`,
  // 输出文件目录
  outputDir: "dist",
